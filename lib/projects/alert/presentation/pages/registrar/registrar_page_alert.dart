...
class _RegistrarPageAlertState extends State<RegistrarPageAlert> {
  ...
  void _updateDateTime() {
    ...
    int minutesToAdd = 3 - (now.minute % 3);
    DateTime nextUpdateTime = now.add(Duration(minutes: minutesToAdd));

    formattedDateTime = DateFormat.Hm().format(nextUpdateTime);
                    ...
                    SleekCircularSlider(
                      ...
                      appearance: CircularSliderAppearance(
                        ...
                        customColors: CustomSliderColors(
                          ...
                          hideShadow: true,
                          dotColor: const Color.fromRGBO(93, 174, 199, 1)
                              .withOpacity(0.5),
                        ),
                        ...
                        onPressed: isEnabled
                            ? () {
                                setState(() {
                                  ...
                                  isEnabled = false;
                                  hasElapsed60Seconds =
                                      elapsedTimeExceeded(lastMarkedTime!);
