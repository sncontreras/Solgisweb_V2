...
import 'package:solgis/projects/people/presentation/widgets/modal_fit_guia.dart';
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: ( ingresoProvider.selectedGuias.isEmpty)
              ? const Text("Ingrese las guias")
              : Text(ingresoProvider.selectedGuias.length.toString())
          ),
        ),
