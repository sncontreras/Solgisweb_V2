...
class CargaStateEntryDataWidget extends StatefulWidget {
  const CargaStateEntryDataWidget({super.key});

  @override
  State<CargaStateEntryDataWidget> createState() => _CargaStateEntryDataWidgetState();
}

class _CargaStateEntryDataWidgetState extends State<CargaStateEntryDataWidget> {
