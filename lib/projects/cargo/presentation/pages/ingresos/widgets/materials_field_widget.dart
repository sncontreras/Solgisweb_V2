...
class MaterialsFieldWidget extends StatelessWidget {

  const MaterialsFieldWidget({Key? key}) : super(key: key);
      ...
      children: [
        ...
        GestureDetector(
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: ( _ , i) {
                            ...
                            return ListTile(
                              ...
                              onTap: (){
                                entryProvider.materialSelected = carga;
          ...
          child: Container(
            ...
            child: ( entryProvider.materialSelected.codigo == null )
              ? const Text( "Seleccione el Tipo de Material" )
              : Text( StringHelper.patternString( entryProvider.materialSelected.cargaType! ) )
          ),
        ),
