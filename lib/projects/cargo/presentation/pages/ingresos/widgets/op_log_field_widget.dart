...
class OpLogFieldWidget extends StatelessWidget {

  const OpLogFieldWidget({Key? key}) : super(key: key);
      ...
      children: [
        ...
        GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: operators.map(
                        (option) => ListTile(
                          ...
                          onTap: (){
                            entryProvider.selectedOperator=  option;
          ...
          child: Container(
            ...
            child: ( entryProvider.selectedOperator.operatorCode == null )
              ? const Text("Seleccione el Operador logistico")
              : Text(entryProvider.selectedOperator.name!)
          ),
        ),
