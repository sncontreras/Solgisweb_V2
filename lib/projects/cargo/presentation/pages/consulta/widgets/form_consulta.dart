...
import 'package:solgis/projects/cargo/core/helpers/validar_consulta_cargo.dart';
...
class FormConsultaCargo extends StatefulWidget {
  const FormConsultaCargo({Key? key}) : super(key: key);

  @override
  State<FormConsultaCargo> createState() => _RegisterScanGunCargoState();
}

class _RegisterScanGunCargoState extends State<FormConsultaCargo> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Expanded(
                    flex: 1,
                    child: AutoSizeText('Ingrese placa',
                        style: AppThemePeople
                            .lighThemePeople.textTheme.displayMedium)),
                Expanded(
                  flex: 8,
                  child: TextField(
                    ...
                    onSubmitted: (value) {
                      if (value == '') {
                        return showSnackBarAwesome(context, 'Atencion',
                            'Escanee el QR correctamente', ContentType.failure);
                      }
                      validarConsultaCargo(
                        context,
                        value,
                        loginProvider.codigoServicio.toString(),
                        loginProvider.codigoCliente!
                      );
                      myController.text = '';
