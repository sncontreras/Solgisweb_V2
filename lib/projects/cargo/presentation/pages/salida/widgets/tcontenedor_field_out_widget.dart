...
class TContenedorFieldOutWidget extends StatelessWidget {

  const TContenedorFieldOutWidget({Key? key}) : super(key: key);
      ...
      children: [
        ...
        GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: options.map(
                        (option) => ListTile(
                          ...
                          onTap:  () {
                            outProvider.selectedOptionRadio = option;
          ...
          child: Container(
            ...
            child: ( outProvider.selectedOptionRadio.codeOptionRadio == null )
              ? const Text( "Seleccione el tamaño del contenedor" )
              : Text(outProvider.selectedOptionRadio.tamanio.toString())
          ),
        ),
