...
class OrigenFieldOutWidget extends StatelessWidget {

  const OrigenFieldOutWidget({Key? key}) : super(key: key);
      ...
      children: [
        ...
        GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: origins.map(
                        (option) => ListTile(
                          ...
                          onTap: (){
                            outProvider.selectedOrigin= option;
          ...
          child: Container(
            ...
            child: ( outProvider.selectedOrigin.originCode == null )
              ? const Text("Seleccione el origen del viaje")
              : Text(outProvider.selectedOrigin.origin!)
          ),
        ),
