...
class RegisterScanGunCargo extends StatefulWidget {
  const RegisterScanGunCargo({Key? key}) : super(key: key);

  @override
  State<RegisterScanGunCargo> createState() => _RegisterScanGunCargoState();
}

class _RegisterScanGunCargoState extends State<RegisterScanGunCargo> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Expanded(
                    flex: 1,
                    child: AutoSizeText('Escanee el fotocontrol',
